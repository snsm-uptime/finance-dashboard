...
/**
 * Same-origin BFF for card identification (Story 4.8.1).
 * browser → ui /api/import/sessions/{id}/statements/{id}/identify-card
 *        → api /import/sessions/{id}/statements/{id}/identify-card
 */
export async function POST(
  ...
  try {
    ...
    return NextResponse.json(
      { detail: "Invalid request body.", code: "invalid_body" },
      { status: 400 },
    );
  }
