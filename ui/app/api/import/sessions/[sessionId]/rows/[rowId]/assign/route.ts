...
/**
 * Same-origin BFF: POST /api/import/sessions/{sessionId}/rows/{rowId}/assign →
 * api /import/sessions/{sessionId}/rows/{rowId}/assign.
 */
export async function POST(request: NextRequest, context: RouteContext) {
  ...
  try {
    upstream = await fetch(
      `${getApiInternalUrl()}/import/sessions/${encodeURIComponent(sessionId)}/rows/${encodeURIComponent(rowId)}/assign`,
      {
        method: "POST",
        headers,
