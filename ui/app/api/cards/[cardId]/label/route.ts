...
/**
 * Same-origin BFF: /api/cards/{cardId}/label → api /cards/{cardId}/label
 * (inline card label rename).
 */
export async function PATCH(request: NextRequest, context: RouteContext) {
  ...
  try {
    upstream = await fetch(`${getApiInternalUrl()}/cards/${encodeURIComponent(cardId)}/label`, {
      method: "PATCH",
      headers,
