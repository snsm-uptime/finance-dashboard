...
describe("GET /api/budgets/[budgetId]/candidates BFF", () => {
  beforeEach(() => {
    fetchMock.mockReset();
  ...
  it("forwards the cookie and passes through the upstream candidates body", async () => {
    ...
    const request = new Request("http://localhost/api/budgets/b1/candidates", {
    ...
    expect(url).toBe("http://api.test:8000/budgets/b1/candidates");
