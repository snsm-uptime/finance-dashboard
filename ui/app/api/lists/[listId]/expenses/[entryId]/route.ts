...
/**
 * Same-origin BFF: /api/lists/{id}/expenses/{entryId} → api /lists/{id}/expenses/{entryId}.
 */
export async function PATCH(request: NextRequest, context: RouteContext) {
  ...
  try {
    upstream = await fetch(
      `${getApiInternalUrl()}/lists/${encodeURIComponent(listId)}/expenses/${encodeURIComponent(entryId)}`,
      {
        method: "PATCH",
        headers,
