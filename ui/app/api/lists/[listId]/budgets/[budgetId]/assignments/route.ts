...
/**
 * Same-origin BFF: POST /api/lists/{id}/budgets/{budgetId}/assignments
 * → api POST /lists/{id}/budgets/{budgetId}/assignments.
 */
export async function POST(request: NextRequest, context: RouteContext) {
  ...
  try {
    upstream = await fetch(
      `${getApiInternalUrl()}/lists/${encodeURIComponent(listId)}/budgets/${encodeURIComponent(budgetId)}/assignments`,
      {
        method: "POST",
        headers,
