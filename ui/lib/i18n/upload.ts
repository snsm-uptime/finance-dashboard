...
export const uploadMessages = {
  en: {
    ...
    discardConfirmTitle: "Discard remaining review?",
    discardConfirmBody:
      "Expenses already assigned stay on their lists. Only unreviewed transactions are abandoned.",
    discardConfirmAction: "Discard remaining",
    discardCancel: "Keep reviewing",
    completionTitle: "Import complete",
    completionImportedToList: "Added to {list}",
    completionDeleted: "Deleted",
    completionZeroExcluded: "Zero-amount excluded",
    completionZeroExcludedHint: "Check the PDF if you expected a charge.",
    completionFailedStatement: "Could not parse {filename}",
    completionImportedNew: "Imported",
    completionSkippedDuplicate: "Skipped as duplicates",
    completionReviewAnotherFile: "Review another file",
    completionReturnHome: "Return Home",
    completionGoToList: "Go to {list}",
    ...
    errorDuplicateStatement: "This statement has already been uploaded.",
    errorAlreadyQueued: "Already added.",
    ...
    parseFailureAddManually: "Add manually",
    parseFailureManualEntryRegion: "Manual entry",
    manualEntryChooseList: "List",
    manualEntryLoadingLists: "Loading lists…",
    manualEntryBack: "Back",
    manualEntrySave: "Save expense",
    manualEntryLoadingUser: "Loading your account…",
    manualEntryDismissRetry: "Expense created — retry dismissing the statement",
    manualEntryLoadRetry: "Retry",
    ...
    individualReviewLoadingCard: "Identifying your card…",
    ...
    individualReviewKeyboardLegend: "Keyboard shortcuts",
    individualReviewKeyTooltipUp: "Choose list",
    individualReviewKeyTooltipDown: "Undo",
    individualReviewKeyTooltipBackspace: "Delete",
  ...
  es: {
    ...
    close: "Cerrar",
    closing: "Cerrando…",
    resumeReview: "Continuar revisión",
    discardConfirmTitle: "¿Descartar el resto de la revisión?",
    discardConfirmBody:
      "Los gastos ya asignados se quedan en sus listas. Solo se abandonan las transacciones sin revisar.",
    discardConfirmAction: "Descartar el resto",
    discardCancel: "Seguir revisando",
    completionTitle: "Importación completa",
    completionImportedToList: "Agregados a {list}",
    completionDeleted: "Eliminados",
    completionZeroExcluded: "En cero excluidas",
    completionZeroExcludedHint: "Revisa el PDF si esperabas un cargo.",
    completionFailedStatement: "No se pudo leer {filename}",
    completionImportedNew: "Importados",
    completionSkippedDuplicate: "Omitidos por duplicado",
    completionReviewAnotherFile: "Revisar otro archivo",
    completionReturnHome: "Volver al inicio",
    completionGoToList: "Ir a {list}",
    ...
    errorDuplicateStatement: "Este estado de cuenta ya fue subido.",
    errorAlreadyQueued: "Ya está en la cola.",
    ...
    parseFailureAddManually: "Agregar manualmente",
    parseFailureManualEntryRegion: "Entrada manual",
    manualEntryChooseList: "Lista",
    manualEntryLoadingLists: "Cargando listas…",
    manualEntryBack: "Atrás",
    manualEntrySave: "Guardar gasto",
    manualEntryLoadingUser: "Cargando tu cuenta…",
    manualEntryDismissRetry: "Gasto creado — reintentar descartar el estado de cuenta",
    manualEntryLoadRetry: "Reintentar",
    // Bulk review (Story 4.7)
    ...
    individualReviewLoadingCard: "Identificando tu tarjeta…",
    ...
    individualReviewKeyboardLegend: "Atajos de teclado",
    individualReviewKeyTooltipUp: "Elegir lista",
    individualReviewKeyTooltipDown: "Deshacer",
    individualReviewKeyTooltipBackspace: "Eliminar",
