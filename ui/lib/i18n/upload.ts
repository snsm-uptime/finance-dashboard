...
export const uploadMessages = {
  en: {
    ...
    individualReviewDirectionHintTouch: "Drag the card, or use the ← → arrow keys",
    individualReviewDirectionHintKeyboard: "Use the ← → arrow keys",
  ...
  es: {
    ...
    individualReviewDirectionHintTouch: "Arrastra la tarjeta o usa las flechas ← →",
    individualReviewDirectionHintKeyboard: "Usa las flechas ← →",
