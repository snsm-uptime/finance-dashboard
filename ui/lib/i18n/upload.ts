...
export const uploadMessages = {
  en: {
    ...
    individualReviewDirectionHintTouch: "Drag the card, or use the {left} {right} arrow keys",
  ...
  es: {
    ...
    individualReviewDirectionHintTouch: "Arrastra la tarjeta o usa las flechas {left} {right}",
