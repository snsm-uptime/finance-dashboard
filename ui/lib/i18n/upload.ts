...
export const uploadMessages = {
  en: {
    ...
    completionImportedToList: "{count} added to {list}",
    completionDeleted: "{count} deleted",
    completionZeroExcluded:
      "{count} zero-amount lines were excluded. Check the PDF if you expected a charge.",
    completionFailedStatement: "Could not parse {filename}",
    completionImportedNew: "{count} imported",
    completionSkippedDuplicate: "{count} skipped as duplicates",
    completionContinue: "Continue",
    completionBackToReview: "Back to review",
  ...
  es: {
    ...
    completionImportedToList: "{count} agregados a {list}",
    completionDeleted: "{count} eliminados",
    completionZeroExcluded:
      "Se excluyeron {count} líneas en cero. Revisa el PDF si esperabas un cargo.",
    completionFailedStatement: "No se pudo leer {filename}",
    completionImportedNew: "{count} importados",
    completionSkippedDuplicate: "{count} omitidos por duplicado",
    completionContinue: "Continuar",
    completionBackToReview: "Volver a la revisión",
