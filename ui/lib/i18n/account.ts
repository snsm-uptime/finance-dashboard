...
export const accountMessages = {
  en: {
    ...
    defaultOriginTitle: "Default expense origin",
    defaultOriginCash: "Cash",
    defaultOriginBlank: "None",
    saveDefaultOriginFailed: "Could not save default origin. Try again.",
  ...
  es: {
    ...
    defaultOriginTitle: "Origen de gasto por defecto",
    defaultOriginCash: "Efectivo",
    defaultOriginBlank: "Ninguno",
    saveDefaultOriginFailed: "No se pudo guardar el origen por defecto. Inténtalo de nuevo.",
