...
export const listsMessages = {
  en: {
    ...
    expenseCurrencyCrc: "Colones (CRC)",
    expenseCurrencyUsd: "Dollars (USD)",
    ...
    editExpenseDateLabel: "Date",
    editExpenseSave: "Save changes",
    editExpenseSaving: "Saving…",
    editExpenseCancel: "Cancel",
    ...
    budgetsManageSourcesAria: "Manage budget sources",
    ...
    budgetsShowArchived: "Show archived budgets",
    budgetsShowActive: "Show active budgets",
    budgetsArchivedEmpty: "No archived budgets.",
    ...
    errorBudgetNotArchived: "Archive the budget before deleting it.",
    ...
    budgetsDeleteConfirmBody:
      "This permanently deletes the budget. Expenses already recorded on its lists are not affected.",
  ...
  es: {
    ...
    expenseCurrencyCrc: "Colones (CRC)",
    expenseCurrencyUsd: "Dólares (USD)",
    expenseDateLabel: "Fecha",
    ...
    editExpenseDateLabel: "Fecha",
    editExpenseSave: "Guardar cambios",
    editExpenseSaving: "Guardando…",
    editExpenseCancel: "Cancelar",
    deleteExpenseConfirmTitle: "¿Eliminar este gasto?",
    deleteExpenseConfirmBody: "Esto lo elimina de la lista permanentemente.",
    ...
    budgetsHistoryTitle: "Tus Presupuestos",
    budgetsHistoryEmpty:
      "Aún no hay transacciones asignadas a este presupuesto. Asigna una transacción manualmente o gestiona tus reglas arriba.",
    budgetsSourcesHeading: "Fuentes",
    budgetsSpentCaption: "Gastado",
    budgetsCapCaption: "Límite",
    budgetsManageSourcesAria: "Gestionar fuentes del presupuesto",
    budgetsHistoryViaManual: "Manual",
    ...
    budgetsShowArchived: "Mostrar presupuestos archivados",
    budgetsShowActive: "Mostrar presupuestos activos",
    budgetsArchivedEmpty: "No hay presupuestos archivados.",
    budgetsArchive: "Archivar",
    budgetsUnarchive: "Desarchivar",
    budgetsArchived: "Archivado",
    ...
    errorBudgetNotArchived: "Archiva el presupuesto antes de eliminarlo.",
    ...
    budgetsDeleteAria: "Eliminar presupuesto",
    budgetsDeleteConfirmTitle: "¿Eliminar este presupuesto?",
    budgetsDeleteConfirmBody:
      "Esto elimina el presupuesto de forma permanente. Los gastos ya registrados en sus listas no se ven afectados.",
    budgetsDeleteConfirmAction: "Sí, eliminar",
    budgetsDeleting: "Eliminando…",
