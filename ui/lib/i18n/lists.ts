...
export const listsMessages = {
  en: {
    ...
    noOriginFilterToggle: "Items with no origin",
    noOriginFilterEmpty: "No items are missing an origin.",
  ...
  es: {
    ...
    noOriginFilterToggle: "Elementos sin origen",
    noOriginFilterEmpty: "No hay elementos sin origen.",
