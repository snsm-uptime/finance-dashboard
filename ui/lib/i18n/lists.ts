...
export const listsMessages = {
  en: {
    ...
    noOriginFilterToggle: "Your items with no origin",
    noOriginFilterAssign: "Assign",
    noOriginFilterAssigning: "Assigning…",
    noOriginFilterSelectAll: "Assign selected",
  },
  es: {
    brand: "finance-helper",
    title: "Inicio",
    ...
    noOriginFilterToggle: "Tus elementos sin origen",
    noOriginFilterAssign: "Asignar",
    noOriginFilterAssigning: "Asignando…",
    noOriginFilterSelectAll: "Asignar seleccionados",
  },
} as const;
